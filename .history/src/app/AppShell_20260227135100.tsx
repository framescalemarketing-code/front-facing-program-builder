...
export function AppShell(props: {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Clean white nav — blue used only as a subtle accent */}
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
