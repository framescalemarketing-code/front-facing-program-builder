...
const VALID_PAGES: PageId[] = ["recommendation", "recommendation_summary", "recommendation_congratulations"];

function pageFromHash(): PageId {
  if (typeof window === "undefined") return "recommendation";
  const raw = window.location.hash.replace(/^#\/?/, "");
  return VALID_PAGES.includes(raw as PageId) ? (raw as PageId) : "recommendation";
}
