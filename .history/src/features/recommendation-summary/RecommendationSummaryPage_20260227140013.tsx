...
function ProgramSummaryCard(props: {
  ...
  return (
    <div className="rounded-xl border border-border bg-white shadow-sm overflow-hidden">
      ...
      <div className="relative p-6 pb-5 overflow-hidden bg-gray-900">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-white/70 mt-1">
                Your specialist will walk through this with you before anything is set
              </p>
            </div>
            <div
        ...
        <header className="border-b border-gray-200/60 bg-white">
          ...
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-emerald-700 mb-3">
                ...
                <p className="mt-2 max-w-2xl text-gray-500 text-sm">
                  Built from your answers. An OSSO specialist will review this with
                  you before anything moves forward — nothing is locked until you're ready.
                </p>
              </div>
              ...
              <aside className="space-y-5 lg:col-span-4">
                ...
                <article className="rounded-xl border border-primary/30 bg-gradient-to-b from-primary/5 to-transparent p-5">
                  ...
                  <p className="text-xs text-muted-foreground mb-4">
                    Submit this to your OSSO specialist, or save a
                    copy first for your records.
                  </p>
