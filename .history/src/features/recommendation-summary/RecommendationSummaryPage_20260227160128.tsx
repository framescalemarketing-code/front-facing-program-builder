                    ...
                    <div className="divide-y divide-border">
                      ...
                      <div className="p-6">
                        <div className="flex items-center gap-2 mb-3">
                          <span className="flex h-7 w-7 items-center justify-center rounded-full bg-emerald-100 text-sm" aria-hidden="true">✓</span>
                          <span className="text-xs font-bold uppercase tracking-widest text-emerald-600">Your Recommendation</span>
                        </div>
                      ...
                      {packageTierSummary && (
                        <div className="px-6 py-5 bg-gradient-to-r from-slate-50 to-white">
                          <div className="flex gap-3">
                            <div className="shrink-0 mt-0.5 flex h-8 w-1 rounded-full bg-[#2971b5]" />
                            <div>
                              <p className="text-xs font-bold uppercase tracking-wide text-[#244093] mb-1">
                                Why this combination
                              </p>
                              <p className="text-sm text-slate-600 leading-relaxed">
                                {packageTierSummary}
                      ...
                      <div className="px-6 py-5">
                        ...
                        <div className="grid gap-2.5 sm:grid-cols-3">
                          <div className="rounded-lg bg-gradient-to-br from-[#244093]/[0.06] to-[#2971b5]/[0.03] border border-[#2971b5]/15 px-4 py-3">
                            <span className="text-[10px] font-semibold uppercase tracking-wide text-[#244093]/60">
                              EU Package
                            </span>
                            <p className="text-base font-bold text-[#244093] mt-0.5">
                              {selectedPackage ?? "—"}
                            </p>
                          </div>
                          <div className="rounded-lg bg-gradient-to-br from-[#244093]/[0.06] to-[#2971b5]/[0.03] border border-[#2971b5]/15 px-4 py-3">
                          ...
                          <div className="rounded-lg bg-gradient-to-br from-slate-50 to-white border border-border px-4 py-3">
                      ...
                      {/* Posture + Operations Row */}
                      <div className="px-6 py-5">
                        <h4 className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-3">
                          Program Profile
                        </h4>
                        <div className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-4">
                          <div className="rounded-lg border border-border bg-slate-50/60 px-4 py-3">
                            <span className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground">
                              Posture
                            </span>
                            <p className="text-sm font-bold mt-0.5" style={{ color: posture.accentColor }}>
                      ...
                      <div className="px-6 py-5">
                        <div className="grid gap-4 sm:grid-cols-2">
                          {/* Locations summary */}
                          <div className="rounded-lg border border-border bg-slate-50/40 p-4">
                            ...
                            <p className="text-sm text-slate-600">
                              {locationModel ?? "Not specified"}
                              {locations.length > 0 && (
                                <span className="ml-1 text-xs font-medium text-muted-foreground">
                                  ({locations.length} site{locations.length !== 1 ? "s" : ""} added)
                                </span>
                              )}
                            </p>
                      ...
                      {/* Coatings summary (just names, details on coatings tab) */}
                      {(programConfig.coatingRecommendations ?? []).length > 0 && (
                        <div className="px-6 py-5">
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-base" aria-hidden="true">💡</span>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {(programConfig.coatingRecommendations ?? []).map(
                              (coating: CoatingRecommendation) => (
                                <span
                                  key={coating.id}
                                  className="inline-flex rounded-full border border-amber-200/80 bg-amber-50/60 px-3 py-1 text-xs font-medium text-amber-800"
                                >
                                  {coating.label}
                                </span>
                              ),
                          ...
                          <p className="text-xs text-muted-foreground mt-2">
                            Switch to the <strong>Coatings</strong> tab for details on why each was recommended.
                          </p>
                        </div>
                      )}

                      {/* Trust / next step callout */}
                      <div className="px-6 py-5 bg-gradient-to-r from-emerald-50/50 to-white">
