  ...
  return (
    <section aria-labelledby="recommendation-preview-title">
            ...
            <div className="grid gap-6 lg:grid-cols-12">
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                <article className="rounded-xl border border-slate-200/80 bg-white shadow-sm overflow-hidden">
                  ...
                  {/* Profile tab: program profile explanation + budget context */}
                  {activeCardSection === "profile" && (
                    <div className="p-0">
                      {/* Posture header */}
                      <div className="px-6 pt-6 pb-5 bg-gradient-to-br from-slate-50 via-white to-slate-50/80">
                        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2">Derived Program Posture</p>
                      ...
                      <div className="px-6 py-4 border-t border-slate-100 bg-gradient-to-r from-[#244093]/[0.03] to-[#2971b5]/[0.02]">
                        <p className="text-xs font-semibold uppercase tracking-wide text-[#244093]/70 mb-1">How this is determined</p>
                        <p className="text-sm text-slate-600 leading-relaxed">
                          Your posture is derived from the full picture — team size, number of locations, exposure complexity, delivery structure, and approval routing. It's not a preference you pick; it reflects where your program actually sits today.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {activeCardSection === "coverage" && (
                    <div className="p-0">
                      {/* Coverage metrics */}
                      <div className="px-6 pt-6 pb-5 bg-gradient-to-br from-slate-50 via-white to-slate-50/80">
                        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-3">Coverage Configuration</p>
                        <div className="grid grid-cols-3 gap-4">
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">EU Package</span>
                            <span className="text-lg font-bold text-[#244093]">{selectedPackage ?? "—"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Service Tier</span>
                            <span className="text-lg font-bold text-[#244093]">{serviceTier ?? "—"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Coverage Band</span>
                            <span className="text-sm font-bold text-slate-800">{coverageBand ? `${coverageBand} employees` : "—"}</span>
                          </div>
                        </div>
                      </div>
                  ...
                  {activeCardSection === "coatings" &&
                    (programConfig.coatingRecommendations ?? []).length > 0 && (
                      <div className="p-0">
                        <div className="px-6 pt-6 pb-5 bg-gradient-to-br from-slate-50 via-white to-slate-50/80">
                          <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-1">Recommended Coatings</p>
                          <p className="text-sm text-slate-500">Based on your industry and exposure profile</p>
                        </div>
                        <div className="px-6 py-5 border-t border-slate-100">
                              ...
                              (coating: CoatingRecommendation) => (
                                ...
                                >
                                  ...
                                  <div className="flex items-start gap-1.5">
                                    <span className="text-[#2971b5]/60 text-xs mt-px shrink-0">→</span>
                  ...
                  {activeCardSection === "logistics" && (
                    <div className="p-0">
                      {/* Operations overview */}
                      <div className="px-6 pt-6 pb-5 bg-gradient-to-br from-slate-50 via-white to-slate-50/80">
                        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-3">Operations & Logistics</p>
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Work Type</span>
                            <span className="text-sm font-bold text-slate-800">{workType ?? "Not set"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Delivery</span>
                            <span className="text-sm font-bold text-slate-800">{deliveryModel ?? "Not set"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Approval</span>
                            <span className="text-sm font-bold text-slate-800">{approvalModel ?? "Not set"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Location Model</span>
                            <span className="text-sm font-bold text-slate-800">{locationModel ?? "Not set"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Program Posture</span>
                            <span className="text-sm font-bold text-slate-800">{programPosture ?? "Not set"}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Locations */}
                      <div className="px-6 py-5 border-t border-slate-100">
                        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-3">Locations</p>
                        {locations.length === 0 ? (
                  ...
                  {activeCardSection === "contact" && (
                    <div className="p-0">
                      <div className="px-6 pt-6 pb-5 bg-gradient-to-br from-slate-50 via-white to-slate-50/80">
                        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-3">Contact & Profile</p>
                        <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Company</span>
                            <span className="text-sm font-bold text-slate-800">{companyName ?? "Not provided"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Safety Contact</span>
                            <span className="text-sm font-bold text-slate-800">{contactName ?? "Not provided"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Role</span>
                            <span className="text-sm font-bold text-slate-800">{contactRole ?? "Not provided"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Email</span>
                            <span className="text-sm font-bold text-slate-800">{email ?? "Not provided"}</span>
                          </div>
                          <div>
                            <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block mb-0.5">Phone</span>
                            <span className="text-sm font-bold text-slate-800">{phone ?? "Not provided"}</span>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div className="print-only recommendation-summary-print">
        ...
        <section className="print-section">
          <h2>Program profile and rationale</h2>
          <p>
        ...
        <section className="print-section">
          ...
          <table>
            <tbody>
              ...
              <PrintDataRow label="Program Profile" value={programPosture} />
