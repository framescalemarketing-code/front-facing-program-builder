...
export function RecommendationSummaryPage({
  ...
  return (
    <section aria-labelledby="recommendation-preview-title">
      ...
      {/* Print-only version — clean, soft, market-ready layout */}
              ...
              <div className="print-two-col">
                {companyName && (
                  <div className="print-data-row">
                    ...
                    <span className="print-data-value">{companyName}</span>
                  </div>
                )}
                {contactName && (
                  <div className="print-data-row">
                    <span className="print-data-label">Contact</span>
                    <span className="print-data-value">{contactName}</span>
                  </div>
                )}
                {email && (
                  <div className="print-data-row">
                    <span className="print-data-label">Email</span>
                    <span className="print-data-value">{email}</span>
                  </div>
                )}
                {phone && (
                  <div className="print-data-row">
                    <span className="print-data-label">Phone</span>
                    <span className="print-data-value">{phone}</span>
                  </div>
                )}
                {contactRole && (
                  <div className="print-data-row">
