      ...
      >
        ...
        <div className="relative">
          <div className="flex items-start justify-between gap-4">
            ...
            <div
              className="shrink-0 rounded-lg px-3 py-2 text-center backdrop-blur-sm bg-white/15 border border-white/25 shadow-lg"
            >
        ...
        {activeSection === "snapshot" && (
          <div className="space-y-4">
            ...
            {props.packageTierSummary && (
              <div className="rounded-lg border-l-4 border-l-[#2971b5] bg-slate-50 p-4">
                <p className="text-xs font-semibold uppercase tracking-wide mb-1 text-[#244093]">
