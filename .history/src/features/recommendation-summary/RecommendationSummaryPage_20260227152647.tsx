            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Based on your industry and exposure profile, these coatings
                  could improve your program.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-12">
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                <ProgramSummaryCard
                  ...
                  coatingRecommendations={programConfig.coatingRecommendations ?? []}
                />
                ...
                <article className="rounded-xl border border-border bg-card overflow-hidden">
                  ...
                  {/* Coating Recommendations — "Did You Consider?" */}
                  {(programConfig.coatingRecommendations ?? []).length > 0 && (
                    <div className="p-5 border-b border-border">
                      <div className="flex items-center gap-2.5 mb-4">
                        <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-50 text-base" aria-hidden="true">💡</span>
                        <div>
                          <h3 className="text-sm font-bold uppercase tracking-wide text-foreground">
                            Did You Consider?
                          </h3>
                          <p className="text-xs text-muted-foreground">
                            Coating recommendations based on your industry and exposure profile
                          </p>
                        </div>
                      </div>
                      <div className="grid gap-3 sm:grid-cols-2">
                          ...
                          (coating: CoatingRecommendation) => (
                            ...
                            >
                              ...
                              <div className="flex items-start gap-1.5">
                                <span className="text-primary/60 text-xs mt-px shrink-0">→</span>
