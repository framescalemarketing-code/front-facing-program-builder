                    ...
                    <div className="divide-y divide-border">
                      ...
                      <div className="p-6">
                        <div className="flex items-center gap-2 mb-3">
                          <span
                            className="flex h-7 w-7 items-center justify-center rounded-full bg-emerald-100 text-sm"
                            aria-hidden="true"
                          >
                            ✓
                          </span>
                        ...
                        <div className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-4">
                          <div className="rounded-lg border border-border bg-slate-50/60 px-4 py-3">
                            ...
                            <p
                              ...
                              style={{ color: posture.accentColor }}
                            >
                      ...
                      {(programConfig.coatingRecommendations ?? []).length >
                        ...
                        <div className="px-6 py-5">
                          ...
                          <p className="text-xs text-muted-foreground mt-2">
                            Switch to the <strong>Coatings</strong> tab for
                            details on why each was recommended.
                          </p>
                        </div>
                      )}
