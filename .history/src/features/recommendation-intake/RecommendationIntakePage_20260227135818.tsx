...
const BUDGET_OPTIONS: Array<{
...
}> = [
  {
    ...
    helper: "Clear rules, defined eligibility, and predictable approvals — a solid foundation to build on.",
  ...
  },
  {
    ...
    helper: "Keep what's already working and add reliability without extra admin.",
