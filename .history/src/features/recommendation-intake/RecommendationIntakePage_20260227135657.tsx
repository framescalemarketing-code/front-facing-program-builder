...
const STEPS: WizardStep[] = [
  ...
  },
  {
    ...
    heroSubtitle: "This helps us match the right protection to your environment",
                ...
                <div className="rounded-xl overflow-hidden border border-border bg-card">
                  ...
                  <div className="p-5">
                    <p className="text-base font-bold text-foreground">
                      Let's build your program recommendation — it only takes about five minutes.
                    </p>
                    <p className="mt-2 text-sm text-muted-foreground">
                      We'll walk through seven quick questions about your team,
                      your environment, and how things run today. From there,
                      we'll put together a tailored recommendation and connect
                      you with an OSSO specialist to review it together.
                    </p>
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    Tap to {mobileGuidanceOpen ? "minimize" : "see why this matters"}
                  </div>
                </div>
