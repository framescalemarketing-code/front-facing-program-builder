      ...
      <header className="relative border-b border-gray-200/60 bg-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-emerald-50/60 px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-emerald-600">
                <svg
                  viewBox="0 0 16 16"
